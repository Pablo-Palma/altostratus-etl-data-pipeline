...
echo "Actualizando Cloud Scheduler con la nueva URL de la función..."
cd ../../cloud_scheduler
terraform init
terraform apply -auto-approve -var="function_url=${CLOUD_FUNCTION_URL}" -var="project_id=altostratus-dataretobootcaamp" -var="region=us-central1" -var="scheduler_service_account_email=scheduler-sa@altostratus-dataretobootcaamp.iam.gserviceaccount.com"
